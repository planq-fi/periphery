import { abi as IPlanqFiPoolABI } from '@planq-fi/contracts/artifacts/contracts/interfaces/IPlanqFiPool.sol/IPlanqFiPool.json'
import { Fixture } from 'ethereum-waffle'
import { BigNumber, constants, ContractTransaction, Wallet } from 'ethers'
import { ethers, waffle } from 'hardhat'
import { IPlanqFiPool, IWETH9, MockTimeSwapRouter, TestERC20 } from '../typechain'
...
describe('SwapRouter gas tests', function () {
  ...
  const swapRouterFixture: Fixture<{
    ...
    pools: [IPlanqFiPool, IPlanqFiPool, IPlanqFiPool]
    ...
    const pools = poolAddresses.map((poolAddress) => new ethers.Contract(poolAddress, IPlanqFiPoolABI, wallet)) as [
      IPlanqFiPool,
      IPlanqFiPool,
      IPlanqFiPool
    ]
  ...
  let pools: [IPlanqFiPool, IPlanqFiPool, IPlanqFiPool]
  ...
  describe('#exactInput', () => {
    ...
    it('0 -> 1 minimal', async () => {
      const calleeFactory = await ethers.getContractFactory('TestPlanqFiCallee')
